...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { Direccio: @buyer.Direccio, Index: @buyer.Index, Nombre: @buyer.Nombre, Telefono: @buyer.Telefono }
    end
  ...
  test "should update buyer" do
    patch :update, id: @buyer, buyer: { Direccio: @buyer.Direccio, Index: @buyer.Index, Nombre: @buyer.Nombre, Telefono: @buyer.Telefono }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
