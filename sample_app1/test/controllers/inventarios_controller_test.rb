...
class InventariosControllerTest < ActionController::TestCase
  ...
  test "should create inventario" do
    assert_difference('Inventario.count') do
      post :create, inventario: { cantidad: @inventario.cantidad, descripcion: @inventario.descripcion, id_venta: @inventario.id_venta, nombre: @inventario.nombre }
    end
  ...
  test "should update inventario" do
    patch :update, id: @inventario, inventario: { cantidad: @inventario.cantidad, descripcion: @inventario.descripcion, id_venta: @inventario.id_venta, nombre: @inventario.nombre }
    assert_redirected_to inventario_path(assigns(:inventario))
  end
